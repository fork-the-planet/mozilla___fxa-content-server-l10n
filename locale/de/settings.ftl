...
passkey-rename-input-label = Zugangsschlüssel-Name
...
passkey-rename-error-too-long = Der Name muss weniger als 256 Zeichen enthalten.
...
auth-error-233 = Um einen Zugangsschlüssel zu erstellen, richten Sie eine Display-Sperre, eine PIN, einen Fingerabdruck oder eine Gesichtserkennung auf Ihrem Geräte- oder Sicherheitsschlüssel ein. Versuchen Sie es dann erneut.
