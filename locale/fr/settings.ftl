...
passkey-rename-error-empty = Saisir un nom pour cette clé d’accès
...
auth-error-233 = Pour créer une clé d’accès, configurez le verrouillage de l’écran, un code PIN, une empreinte digitale, la reconnaissance faciale ou la clé de sécurité de votre appareil. Réessayez ensuite.
